...
export const fontsStyle = () => {
   // подключение шрифтов в файл стилей fonts.scss
   let fontsFile = `${app.path.srcFolder}/scss/1_fonts.scss`;
   ...
   fs.readdir(app.path.build.fonts, function (err, fontsFiles) {
      if (fontsFiles) {
         ...
         if (!fs.existsSync(fontsFile)) {
            ...
            console.log("файл scss/1_fonts.scss уже существует. для обновления файла нужно его удалить ")
         }
      }
   });
